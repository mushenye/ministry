...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('register', '0002_calenderevent_is_on_date'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='eventactivity',
            name='church',
            field=models.CharField(choices=[('South B', 'South B'), ('Kiambiu', 'Kiambiu'), ('Kitengela', 'Kitengela'), ('Waudo', 'Waudo'), ('Eastleigh', 'Eastleigh'), ('Umoja', 'Umoja'), ('Muthaiga', 'Muthaiga'), ('Runda', 'Runda'), ('Kariokor', 'Kariokor'), ('KMM', 'KMM')], max_length=20),
        ),
        migrations.AddField(
            model_name='eventactivity',
            name='event',
